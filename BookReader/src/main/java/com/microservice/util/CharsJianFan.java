...
public class CharsJianFan {

	private static final Character CharacterCache[] = new Character[Character.MAX_VALUE];

	private static final HashMap<Integer, Integer> cht2chsMap = new HashMap<Integer, Integer>(
			3096);

	private static final HashMap<Integer, Integer> chs2chtMap = new HashMap<Integer, Integer>(
			3096);

	public static CharsJianFan charsJianFan = null;

	public CharsJianFan() {
		initAll();
	}

	public static synchronized CharsJianFan getInstance() {
		if (charsJianFan == null)
			charsJianFan = new CharsJianFan();
	...
	public char cht2chs(char c) {
		return (char) cht2chs((int) c);
	}

	public int cht2chs(int codePoint) {
	...
	public char chs2cht(char c) {
		return (char) chs2cht((int) c);
	}

	public int chs2cht(int codePoint) {
		int r = chs2chtMap.get(codePoint);
		return r > 0 ? r : codePoint;
	}

	public char quan2ban(char c) {
		return (char) quan2ban((int) c);
	}

	public int quan2ban(int codePoint) {
	...
	public char ban2quan(char c) {
		return (char) ban2quan((int) c);
	}

	public int ban2quan(int codePoint) {
	...
	public String cht2chs(String strFan) {
		if ((strFan == null) || (strFan.length() <= 0))
			return "";

		StringBuffer bufSimple = new StringBuffer(4096);
		char[] charFan = strFan.toCharArray();

		for (int i = 0; i < charFan.length; i++) {
			bufSimple.append(charsJianFan.cht2chs(charFan[i]));
		}

		return bufSimple.toString();
	}

	public String chs2cht(String strJian) {
		if ((strJian == null) || (strJian.length() <= 0))
			return "";

		StringBuffer bufSimple = new StringBuffer(4096);
		char[] charJian = strJian.toCharArray();

		for (int i = 0; i < charJian.length; i++) {
			bufSimple.append(charsJianFan.chs2cht(charJian[i]));
		}
	...
	public static void main(String[] args) {
		...
		String strFan = "�r���Ǉ��H�ܺ�";

		CharsJianFan charsJianFan = CharsJianFan.getInstance();
		System.out.println("Simple=" + charsJianFan.cht2chs(strFan));
